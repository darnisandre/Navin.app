...
public class InternalCache {
    ...
    private static final String ROUTES_PERSONALIZED_KEY = "routes_personalized_%s";
    ...
    public List<RouteDTO> getRoutesPersonalized(final int locationId) {
        String routesKey = String.format(ROUTES_PERSONALIZED_KEY, locationId);
        List<RouteDTO> routes = (List<RouteDTO>) InternalStorage.readObject(context, routesKey);
        if (routes == null) {
    ...
    public void setRoutesPersonalized(final int locationId, final List<RouteDTO> routes) {
        String routesKey = String.format(ROUTES_PERSONALIZED_KEY, locationId);
        InternalStorage.writeObject(context, routesKey, routes);
    }
    ...
    private void cleanCacheLocation(Long locationId) {
        ...
        InternalStorage.deleteObject(context, String.format(ROUTES_PERSONALIZED_KEY, locationId));
